/**
 * Wire DTOs for the PokeWallet API (https://www.pokewallet.io/api-docs).
 * Everything is optional/nullable because the shapes come from outside the
 * app; pokewalletApi.ts maps them defensively into panel-facing types.
 */
