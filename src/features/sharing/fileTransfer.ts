/**
 * File-based save/load: download the binder as a .json file and read one
 * back in. This is the backup path for binders too large for a share URL
 * (e.g. with several uploaded images embedded as data URLs).
 */
