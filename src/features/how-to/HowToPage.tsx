/**
 * The "How to use" guide, on its own hash route (#/how-to) so the planner UI
 * can stay clean: long instructions live here instead of inline hints.
 *
 * Illustrations are pure CSS mocks (no image downloads). Real screenshots
 * can replace them later by dropping <img> elements into the figure slots.
 */
